...
def layout_console(ttl="Discord messages from subscribed channels", key="-MLINE-__WRITE ONLY__"):
    layout = [
        [sg.Text(ttl, size=(100, 1))],
        [
...
def trigger_alerts_layout():
    ...
    lay = [
        [
            ...
            sg.Button(
                "▲", key="-toggle", enable_events=True, tooltip="Show/hide change alert action"
            ),
            sg.Input(
                default_text="Author, STC 1 AAA 115C 05/30 @2.5 [click port row number to prefill]",
                size=(100, 1),
                key="-subm-msg",
                tooltip=tp_trig,
            ),
            sg.Button(
                "Trigger alert",
                key="-subm-alert",
                tooltip="Will generate alert in user or/and analysts portfolio, useful to close or open a position",
                size=(20, 1),
            ),
            sg.Stretch(),
        ],
        [
            sg.Text(
                "Change alert to:",
                key="-alert_to-",
                tooltip="Change  current alert in tigger alert",
                visible=True,
            ),
            sg.Button(
                "BTO",
                key="-alert_BTO",
                size=(10, 1),
                tooltip="Once clicked portfolio row change prefilled STC to BTO",
                visible=True,
            ),
            sg.Button(
                "STC",
                key="-alert_STC",
                size=(10, 1),
                tooltip="Once clicked portfolio row change prefilled to STC",
                visible=True,
            ),
            sg.Button(
                "STO",
            ...
            sg.Button(
                "ExitUpdate",
                key="-alert_exitupdate",
                size=(20, 1),
                tooltip="Once clicked portfolio row change prefilled STC to exit update",
                visible=True,
            ),
            sg.Button(
                "Get quotes",
                key="-alert_quotes",
                size=(20, 1),
                tooltip="get quotes from alerts in trigger box. In alert pass prices as @m to get market price",
                visible=True,
            ),
            sg.Button(
                "Plot quotes",
                key="-alert_plot",
                size=(20, 1),
                tooltip="plot daily quotes from alerts in trigger box",
                visible=True,
            ),
            sg.Button(
                "author: me",
                key="-alert_tome",
                size=(20, 1),
                tooltip="change author in alert to 'me'",
                visible=True,
            ),
            sg.Button(
                "author: me_short",
                key="-alert_tomeshort",
                size=(30, 1),
                tooltip="change author in alert to 'me_short'",
                visible=True,
            ),
            sg.Button(
                "3 exits 1 SL",
                key="-alert_exits",
                size=(20, 1),
                tooltip="change exits to PT1 20% PT2 40% PT3 60% SL 50%'",
                visible=True,
            ),
            sg.Stretch(),
        ],
    ...
    layout = [
        [
            sg.Column(
                [
                    [
                        sg.Text("Include:  Authors: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="port_filt_author", tooltip=tip),
                        sg.Text("Date from: ", tooltip=tlp_date),
                        sg.Combo(
                            ["today", "week", "month"],
                            default_value="week",
                            key="port_filt_date_frm",
                            tooltip=tlp_date,
                        ),
                        sg.Text(" To: ", tooltip=tlp_date),
                        sg.Combo(
                            ["today", "week", "month"],
                            default_value="today",
                            key="port_filt_date_to",
                            tooltip=tlp_date,
                        ),
                        sg.Text(" Symbols: ", tooltip=tip),
                        sg.Input(key="port_filt_sym", tooltip=tip),
                        sg.Text(" Channels: ", tooltip=tip),
                        sg.Input(key="port_filt_chn", tooltip=tip),
                    ],
                    [
                        sg.Text("Exclude: |"),
                        ...
                        sg.Checkbox(
                            "Canceled", key="-port-Canceled", default=True, enable_events=True
                        ),
                        sg.Checkbox(
                            "Rejected", key="-port-Rejected", default=True, enable_events=True
                        ),
                        ...
                        sg.Text("| Authors: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="port_exc_author", tooltip=tip),
                        sg.Text("Channels: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="port_exc_chn", tooltip=tip),
                    ],
                    [
                        sg.ReadButton(
                            "Update",
        ...
        [
            sg.Column(
                [
                    [
                        sg.Text("Include:  Authors: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="track_filt_author", tooltip=tip),
                        sg.Text("Date from: ", tooltip=tlp_date),
                        sg.Combo(
                            ["today", "week", "month"],
                            default_value="week",
                            key="track_filt_date_frm",
                            tooltip=tlp_date,
                        ),
                        sg.Text(" To: ", tooltip=tlp_date),
                        sg.Combo(
                            ["today", "week", "month"],
                            default_value="",
                            key="track_filt_date_to",
                            tooltip=tlp_date,
                        ),
                        sg.Text(" Symbols: ", tooltip=tip),
                        sg.Input(key="track_filt_sym", tooltip=tip),
                        sg.Text(" Channels: ", tooltip=tip),
                        sg.Input(key="track_filt_chn", tooltip=tip),
                        sg.Text(" DTE: min", tooltip="Days To Expiration min"),
                        sg.Input(key="track_dte_min", tooltip="Days To Expiration min"),
                        sg.Text(" max", tooltip="Days To Expiration max"),
                        sg.Input(key="track_dte_max", tooltip="Days To Expiration max"),
                    ],
                    [
                        sg.Text("Exclude: |"),
                        ...
                        sg.Checkbox(
                            "Stocks", key="-track-stocks", default=True, enable_events=True
                        ),
                        ...
                        sg.Text("| Authors: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="track_exc_author", tooltip=tip),
                        sg.Text("Symbols: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="track_exc_sym", tooltip=tip),
                        sg.Text("Channels: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="track_exc_chn", tooltip=tip),
                    ],
                    [
                        sg.ReadButton(
                            "Update",
        ...
        [
            sg.Column(
                [
                    [
                        sg.Text("Include:  Authors: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="stat_filt_author", tooltip=tip),
                        sg.Text("Date from:", tooltip=tlp_date),
                        sg.Input(key="stat_filt_date_frm", default_text="week", tooltip=tlp_date),
                        sg.Text(" To:", size=(5, 1), tooltip=tlp_date),
                        sg.Input(key="stat_filt_date_to", tooltip=tlp_date),
                        sg.Text(" Symbols:"),
                        sg.Input(key="stat_filt_sym", tooltip=tip),
                        sg.Text(" Max $:", tooltip="calculate stats limiting trades to max $"),
                        sg.Input(
                            key="stat_max_trade_val",
                            tooltip="calculate stats limiting trades to max $ amount",
                        ),
                        sg.Text(
                            " Max quantity:",
                            tooltip="calculate stats limiting trades to max quantity",
                        ),
                        sg.Input(
                            key="stat_max_qty",
                            tooltip="calculate stats limiting trades to max quantity",
                        ...
                        sg.Text(" DTE: min", tooltip="Days To Expiration min"),
                        sg.Input(key="stat_dte_min", tooltip="Days To Expiration min"),
                        sg.Text(" max", tooltip="Days To Expiration max"),
                        sg.Input(key="stat_dte_max", tooltip="Days To Expiration max"),
                    ],
                    [
                        sg.Text("Exclude: "),
                        ...
                        sg.Text("| Authors: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="stat_exc_author", tooltip=tip),
                        sg.Text("Symbols: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="stat_exc_sym", tooltip=tip),
                        sg.Text("Channels: ", auto_size_text=True, tooltip=tip),
                        sg.Input(key="stat_exc_chn", tooltip=tip),
                    ],
                    [
                        sg.ReadButton(
                            "Update",
...
def layout_chan_msg(chn, data_n_headers, font_body, font_header):
    ...
    layout = [
        [
            sg.Text("Filter:  Authors: "),
            sg.Input(key=f"{chn}_filt_author"),
            # sg.Text(' '*2),
            sg.Text("Date from: ", tooltip=tlp_date),
            sg.Input(key=f"{chn}_filt_date_frm", default_text="week", tooltip=tlp_date),
            sg.Text(" To: ", tooltip=tlp_date),
            sg.Input(key=f"{chn}_filt_date_to", tooltip=tlp_date),
            # sg.Text(' '*1),
            sg.Text("Message contains: "),
            sg.Input(key=f"{chn}_filt_cont"),
        ],
        [
            sg.ReadFormButton(
                "Update", button_color=("white", "black"), key=f"{chn}_UPD", bind_return_key=True
            )
        ],
        [
            sg.Column(
    ...
    layout = [
        [
            sg.Column(
                [
                    [
                        tt_acnt("Account ID:", font_body[1]),
                        tt_acnt(ainf["id"], font_body[1], 0, 0, font_body[0]),
                        tt_acnt("Balance:", font_body[1]),
                        tt_acnt(
                            "$" + str(ainf["balance"]), font_body[1], 0, 0, font_body[0], k="acc_b"
                        ),
                        tt_acnt("Cash:", font_body[1]),
                        tt_acnt(
                            "$" + str(ainf["cash"]), font_body[1], 0, 0, font_body[0], k="acc_c"
                        ),
                        tt_acnt("Funds:", font_body[1]),
                        tt_acnt(
                            "$" + str(ainf["funds"]), font_body[1], 0, 0, font_body[0], k="acc_f"
                        ),
                    ],
                    [
                        sg.ReadFormButton(
...
def layout_config(fnt_h, cfg):
    frame1 = [
        [
            sg.Checkbox(
                "Notify alerts to discord",
                default=cfg["discord"].getboolean("notify_alerts_to_discord"),
        ...
        [
            ...
            sg.Input(
                cfg["general"]["off_hours"],
                key="cfg_general.off_hours",
    ...
    frame2 = [
        [
            sg.Checkbox(
                ...
                text_color="black",
                key="cfg_general.do_BTO_trades",
                tooltip="Accept Buy alerts and open trades",
                enable_events=True,
            )
        ],
        [
            sg.Checkbox(
                ...
                text_color="black",
                key="cfg_general.do_STC_trades",
                tooltip="Accept Sell alerts and close trade",
                enable_events=True,
            )
        ],
        [
            sg.Checkbox(
                ...
                tooltip="When BTO alerts, sell current rather than alerted,\nif alerted is too low it will not fill if false",
                enable_events=True,
            )
        ],
        [
            sg.Checkbox(
                "Accept repeated BTO alerts",
                cfg["order_configs"].getboolean("accept_repeated_bto_alerts"),
                text_color="black",
                key="cfg_order_configs.accept_repeated_bto_alerts",
                tooltip="With repeated BTO, it will average down",
                enable_events=True,
            )
        ],
        [
            sg.Text(
                "Authors subscribed:", tooltip="list of authors to follow, e.g. me_long,trader#1234"
            ),
            sg.Input(
                cfg["discord"]["authors_subscribed"],
                key="cfg_discord.authors_subscribed",
        ...
        [
            sg.Text(
                "Channelwise subscription:",
                tooltip="Specify a channel to follow allerts from ALL the authors, useful for challenge accounts",
            ),
            sg.Input(
                cfg["discord"]["channelwise_subscription"],
                key="cfg_discord.channelwise_subscription",
                tooltip="Specify a channel to follow allerts from ALL the authors, useful for challenge accounts",
                enable_events=True,
            ),
        ],
        ...
        [
            ...
            sg.Input(
                ...
                key="cfg_order_configs.max_price_diff",
                enable_events=True,
                tooltip="For stocks and options max value diff to accept current price,\nif not will lim to alerted price",
            ),
        ],
        [
            sg.Text(
                "Kill BTO after x seconds:",
                tooltip="If BTO alert is not filled in this time, it will cancel the order. Leave 0 or empty for None",
            ),
            sg.Input(
                cfg["order_configs"]["kill_if_nofill"],
                key="cfg_order_configs.kill_if_nofill",
                tooltip="If BTO alert is not filled in this time, it will cancel the order",
                enable_events=True,
            ),
        ],
        [
            sg.Text(
                "Default exits (in quotes if not a number, eg. '20%', '50%TS20%'):",
        ...
        [
            sg.Input(
                ...
                key="cfg_order_configs.default_exits",
        ...
        [
            ...
            sg.Drop(
                values=['{"default": "buy_one"}', '{"default": "trade_capital"}'],
                default_value=cfg["order_configs"]["default_bto_qty"],
        ...
        [
            ...
            sg.Input(
                ...
                key="cfg_order_configs.trade_capital",
                enable_events=True,
                tooltip="if default qty == trade_capital, specify the $ amount per trade, qty will be price/capital",
            ),
            sg.Stretch(),
        ...
        [
            ...
            sg.Input(
                cfg["order_configs"]["max_trade_capital"],
                key="cfg_order_configs.max_trade_capital",
                enable_events=True,
                tooltip="Max investment per trade, if alert qty is higher than this, it will only buy max_trade_capital/price",
            ),
            sg.Stretch(),
    ...
    frame3 = [
        [
            sg.Checkbox(
                "Do STO trades, sell to open",
                cfg["shorting"].getboolean("DO_STO_TRADES"),
                text_color="black",
                enable_events=True,
                key="cfg_shorting.DO_STO_TRADES",
                tooltip="Accept Shorting Trades, \b bypassed if user manually triggers alert",
            )
        ],
        [
            sg.Checkbox(
                "Do BTO trades (buy to open, close trade)",
                cfg["shorting"].getboolean("DO_BTC_TRADES"),
                enable_events=True,
                key="cfg_shorting.DO_BTC_TRADES",
                text_color="black",
        ...
        [
            sg.Checkbox(
                "BTC at end of day (EOD)",
                default=cfg["shorting"].getboolean("BTC_EOD"),
                key="cfg_shorting.BTC_EOD",
                text_color="black",
                tooltip="Close at end of day, if not overnight there might be big losses",
                enable_events=True,
            ),
            sg.Stretch(),
        ],
        [
            sg.Checkbox(
                "Accept repeated STO",
                default=cfg["shorting"].getboolean("accept_repeated_sto_alerts"),
                key="cfg_shorting.accept_repeated_sto_alerts",
                text_color="black",
                tooltip="Trade repeated trades",
                enable_events=True,
            ),
            sg.Stretch(),
        ],
        [
            sg.Checkbox(
                "Ignore qty in STO alerts",
                default=cfg["shorting"].getboolean("ignore_alert_qty"),
                key="cfg_shorting.ignore_alert_qty",
                text_color="black",
                tooltip="Ignore qty in STO alerts",
                enable_events=True,
            ),
            sg.Stretch(),
        ],
        [
            sg.Text("STO price:", tooltip="Use price: bid, ask, last or alert"),
            sg.Drop(
                values=["bid", "ask", "mid", "last", "alert"],
                default_value=cfg["shorting"]["STO_price"],
        ...
        [
            ...
            sg.Input(
                cfg["shorting"]["max_price_diff"],
                key="cfg_shorting.max_price_diff",
                enable_events=True,
                tooltip="Max difference allowed between alerted price and current price, if not will lim to alerted price",
            ),
            sg.Stretch(),
        ...
        [
            ...
            sg.Input(
                ...
                key="cfg_shorting.STO_trailingstop",
                enable_events=True,
                tooltip="Trail the price until it drops a %, can be empty so no trailing stop",
            ),
            sg.Stretch(),
        ...
        [
            sg.Text(
                "BTC PT (profit target) %",
                tooltip="The percentage to trigger BTC at a profit, can be empty so no PT",
            ),
            sg.Input(
                cfg["shorting"]["BTC_PT"],
                key="cfg_shorting.BTC_PT",
                enable_events=True,
                tooltip="The percentage to trigger BTC at a profit, can be empty so no PT",
            ),
            sg.Stretch(),
        ...
        [
            ...
            sg.Input(
                cfg["shorting"]["BTC_SL"],
                key="cfg_shorting.BTC_SL",
                enable_events=True,
                tooltip="The percentage to trigger BTC at a stoploss, can be empty so no SL",
            ),
            sg.Stretch(),
        ],
        [
            ...
            sg.Input(
                cfg["shorting"]["BTC_EOD_PT_SL"],
                key="cfg_shorting.BTC_EOD_PT_SL",
                enable_events=True,
                tooltip="Before close, at 3:45 narrow the SL to 5% and PT to 10% of current price, can be empty",
            ),
            sg.Stretch(),
        ...
        [
            sg.Text(
                "Qty based on",
                tooltip="Either 'buy_one' or use 'margin_capital' to calculate quantity",
            ),
            sg.Drop(
                values=["buy_one", "margin_capital"],
                default_value=cfg["shorting"]["default_sto_qty"],
                key="cfg_shorting.default_sto_qty",
                tooltip=" Either 'buy_one' or use 'margin_capital' to calculate quantity",
                size=(30, 1),
                enable_events=True,
            ),
        ...
        [
            ...
            sg.Input(
                cfg["shorting"]["margin_capital"],
                key="cfg_shorting.margin_capital",
                enable_events=True,
                tooltip=" Either 'buy_one' or use 'margin_capital' to calculate quantity",
            ),
            sg.Stretch(),
        ...
        [
            ...
            sg.Input(
                cfg["shorting"]["max_dte"],
                key="cfg_shorting.max_dte",
                enable_events=True,
                tooltip="0 means expiring same day (more volatile and theta decay), 1 means next day, etc",
            ),
            sg.Stretch(),
        ...
        [
            sg.Text(
                "Min price contract", tooltip="Min price contract, an option at 0.5 price is $50"
            ),
            sg.Input(
                cfg["shorting"]["min_price"],
                key="cfg_shorting.min_price",
                enable_events=True,
                tooltip="Min price contract, an option at 0.5 price is $50",
            ),
            sg.Stretch(),
        ],
        [
            sg.Text(
                "Minimum $ per trade",
                tooltip="If the quantity is higher than this, it will only buy the min_trade_capital. If one contract is higher than this, it will not buy",
            ),
            sg.Input(
                cfg["shorting"]["min_trade_capital"],
                key="cfg_shorting.min_trade_capital",
                enable_events=True,
                tooltip="If the quantity is higher than this, it will only buy the min_trade_capital. If one contract is higher than this, it will not buy",
            ),
            sg.Stretch(),
        ...
        [
            sg.Text(
                "Maximum $ per trade",
                tooltip="If the quantity is less than this, it will not trade",
            ),
            sg.Input(
                cfg["shorting"]["max_trade_capital"],
                key="cfg_shorting.max_trade_capital",
                enable_events=True,
                tooltip="If the quantity is less than this, it will not trade",
            ),
            sg.Stretch(),
        ...
        [
            sg.Input(
                cfg["shorting"]["authors_subscribed"],
                key="cfg_shorting.authors_subscribed",
                enable_events=True,
                tooltip="Traders to short, do not put the same names as in [order_configs (long)]. Me_short for GUI alert trigger",
            )
        ],
    ...
    lay = [
        [
            sg.Text(
                "Session Configuration (change config.ini for permanent changes)",
                font=(fnt_h + " bold"),
                text_color="black",
        ...
        [
            sg.Frame(
                "Long Trading", frame2, title_color="lightred", tooltip="Config for long trading"
            ),
            sg.Frame(
                "Short Trading", frame3, title_color="lightred", tooltip="Config for short trading"
            ),
        ],
        [
            sg.ReadButton(
                "Save", button_color=("white", "black"), bind_return_key=True, key="cfg_button"
            )
        ],
    ]
