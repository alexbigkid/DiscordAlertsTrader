...
class webull:
    ...
    def build_req_headers(
        self, include_trade_token=False, include_time=False, include_zone_var=True
    ):
        """
    ...
    def login(
        ...
        response = requests.post(
            self._urls.login(), json=data, headers=headers, timeout=self.timeout
        )
    ...
    def get_mfa(self, username=""):
        ...
        data = {"account": str(username), "accountType": str(account_type), "codeType": 5}

        response = requests.post(
            self._urls.get_mfa(), json=data, headers=self._headers, timeout=self.timeout
        )
        # data = response.json()
    ...
    def check_mfa(self, username="", mfa=""):
        ...
        response = requests.post(
            self._urls.check_mfa(), json=data, headers=self._headers, timeout=self.timeout
        )
        data = response.json()
    ...
    def get_security(self, username=""):
        ...
        response = requests.get(
            self._urls.get_security(
                username, account_type, self._region_code, "PRODUCT_LOGIN", time, 0
            ),
            headers=self._headers,
        ...
        if len(data) == 0:
            response = requests.get(
                self._urls.get_security(
                    username, account_type, self._region_code, "PRODUCT_LOGIN", time, 1
                ),
                headers=self._headers,
                timeout=self.timeout,
            )
    ...
    def check_security(self, username="", question_id="", question_answer=""):
        ...
        response = requests.post(
            self._urls.check_security(), json=data, headers=self._headers, timeout=self.timeout
        )
        data = response.json()
    ...
    def refresh_login(self, save_token=False, token_path=None):
        ...
        response = requests.post(
            self._urls.refresh_login(self._refresh_token),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
        ...
        if (
            ...
            and result["refreshToken"] != ""
            and result["tokenExpireTime"] != ""
        ):
            self._access_token = result["accessToken"]
            self._refresh_token = result["refreshToken"]
            self._token_expire = result["tokenExpireTime"]
    ...
    def get_account(self):
        ...
        headers = self.build_req_headers()
        response = requests.get(
            self._urls.account(self._account_id), headers=headers, timeout=self.timeout
        )
        result = response.json()
        return result
    ...
    def get_activities(self, index=1, size=500):
        ...
        response = requests.post(
            self._urls.account_activities(self._account_id),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def get_history_orders(self, status="All", count=20):
        ...
        headers = self.build_req_headers(include_trade_token=True, include_time=True)
        response = requests.get(
            self._urls.orders(self._account_id, count) + str(status),
            headers=headers,
            timeout=self.timeout,
        )
        return response.json()
    ...
    def get_trade_token(self, password=""):
        ...
        response = requests.post(
            self._urls.trade_token(), json=data, headers=headers, timeout=self.timeout
        )
        result = response.json()
    ...
    def get_ticker(self, stock=""):
        ...
        if stock and isinstance(stock, str):
            response = requests.get(
                self._urls.stock_id(stock, self._region_code), headers=headers, timeout=self.timeout
            )
            result = response.json()
            if result.get("data"):
                for item in result["data"]:  # implies multiple tickers, but only assigns last one?
                    if (
                        "symbol" in item
                        and item["symbol"] == stock
                        or "disSymbol" in item
                        and item["disSymbol"] == stock
                    ):
                ...
                raise ValueError(f"TickerId could not be found for stock {stock}")
        else:
    ...
    def get_all_tickers(self, region_code=None):
        ...
        response = requests.get(
            self._urls.get_all_tickers(region_code, region_code),
            headers=headers,
            timeout=self.timeout,
        )
        result = response.json()
    ...
    def place_order(
        ...
        response = requests.post(
            self._urls.place_orders(self._account_id),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def modify_order(
        ...
        response = requests.post(
            self._urls.modify_order(self._account_id, order_id),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def cancel_order(self, order_id=""):
        ...
        data = {}
        response = requests.post(
            self._urls.cancel_order(self._account_id) + str(order_id) + "/" + str(uuid.uuid4()),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def place_order_otoco(
        ...
        data1 = {
            "newOrders": [
                ...
                },
                {
                    ...
                    "action": "SELL",
                    "tickerId": self.get_ticker(stock),
                    "lmtPrice": float(limit_profit_price),
        ...
        response1 = requests.post(
            self._urls.check_otoco_orders(self._account_id),
            json=data1,
            headers=headers,
            timeout=self.timeout,
        )
        ...
        if result1["forward"]:
            ...
            response2 = requests.post(
                self._urls.place_otoco_orders(self._account_id),
                json=data2,
                headers=headers,
                timeout=self.timeout,
            )
    ...
    def modify_order_otoco(
        ...
        response = requests.post(
            self._urls.modify_otoco_orders(self._account_id),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def cancel_order_otoco(self, combo_id=""):
        ...
        data = {}
        response = requests.post(
            self._urls.cancel_otoco_orders(self._account_id, combo_id),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def get_option_quote(self, stock=None, tId=None, optionId=None):
        ...
        return requests.get(
            self._urls.option_quotes(), params=params, headers=headers, timeout=self.timeout
        ).json()
    ...
    def get_options_expiration_dates(self, stock=None, count=-1):
        ...
        """
        headers = self.build_req_headers()
        data = {"count": count, "direction": "all", "tickerId": self.get_ticker(stock)}

        res = requests.post(
            self._urls.options_exp_dat_new(), json=data, headers=headers, timeout=self.timeout
        ).json()
        r_data = []
    ...
    def get_options(
        self, stock=None, count=-1, includeWeekly=1, direction="all", expireDate=None, queryAll=0
    ):
        """
        ...
        data = {"count": count, "direction": direction, "tickerId": self.get_ticker(stock)}
    ...
    def get_options_by_strike_and_expire_date(
        self, stock=None, expireDate=None, strike=None, direction="all"
    ):
        """
    ...
    def place_order_option(
        ...
        response = requests.post(
            self._urls.place_option_orders(self._account_id),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def modify_order_option(self, order=None, lmtPrice=None, stpPrice=None, enforce=None, quant=0):
        ...
        data = {
            ...
            "orders": [
                {
                    "quantity": quant or order["totalQuantity"],
                    "action": order["action"],
        ...
        if order["orderType"] == "LMT" and (lmtPrice or order.get("lmtPrice")):
            ...
            and (stpPrice or order.get("auxPrice"))
            and (lmtPrice or order.get("lmtPrice"))
        ):
            data["auxPrice"] = stpPrice or order["auxPrice"]
            data["lmtPrice"] = lmtPrice or order["lmtPrice"]

        response = requests.post(
            self._urls.replace_option_orders(self._account_id),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def get_tradable(self, stock=""):
        ...
        headers = self.build_req_headers()
        response = requests.get(
            self._urls.is_tradable(self.get_ticker(stock)), headers=headers, timeout=self.timeout
        )
    ...
    def alerts_remove(self, alert=None, priceAlert=True, smartAlert=True):
        ...
        response = requests.post(
            self._urls.remove_alert(), json=alert, headers=headers, timeout=self.timeout
        )
        if response.status_code != 200:
    ...
    def alerts_add(self, stock=None, frequency=1, interval=1, priceRules=None, smartRules=None):
        ...
        response = requests.post(
            self._urls.add_alert(), json=data, headers=headers, timeout=self.timeout
        )
        if response.status_code != 200:
    ...
    def active_gainer_loser(self, direction="gainer", rank_type="afterMarket", count=50):
        ...
        response = requests.get(
            self._urls.active_gainers_losers(direction, self._region_code, rank_type, count),
            headers=headers,
            timeout=self.timeout,
        )
        result = response.json()
    ...
    def run_screener(
        ...
        if price_lte is not None and price_gte is not None:
            ...
            jdict["rules"]["wlas.screener.rule.price"] = (
                "gte=" + str(price_lte) + "&lte=" + str(price_gte)
            )

        if vol_lte is not None and vol_gte is not None:
            # lte and gte are backwards
            jdict["rules"]["wlas.screener.rule.volume"] = (
                "gte=" + str(vol_lte) + "&lte=" + str(vol_gte)
            )

        if pct_chg_lte is not None and pct_chg_gte is not None:
            # lte and gte are backwards
            jdict["rules"]["wlas.screener.rule.changeRatio"] = (
                "gte=" + str(pct_chg_lte) + "&lte=" + str(pct_chg_gte)
            )
    ...
    def get_analysis(self, stock=None):
        ...
        headers = self.build_req_headers()
        return requests.get(
            self._urls.analysis(self.get_ticker(stock)), headers=headers, timeout=self.timeout
        ).json()
    ...
    def get_capital_flow(self, stock=None, tId=None, show_hist=True):
        ...
        if tId is not None:
            ...
            raise ValueError("Must provide a stock symbol or a stock id")
        return requests.get(
            self._urls.analysis_capital_flow(tId, show_hist), headers=headers, timeout=self.timeout
        ).json()
    ...
    def get_etf_holding(self, stock=None, tId=None, has_num=0, count=50):
        ...
        if tId is not None:
            ...
            raise ValueError("Must provide a stock symbol or a stock id")
        return requests.get(
            self._urls.analysis_etf_holding(tId, has_num, count),
            headers=headers,
            timeout=self.timeout,
        ).json()
    ...
    def get_institutional_holding(self, stock=None, tId=None):
        ...
        if tId is not None:
            ...
            raise ValueError("Must provide a stock symbol or a stock id")
        return requests.get(
            self._urls.analysis_institutional_holding(tId), headers=headers, timeout=self.timeout
        ).json()
    ...
    def get_short_interest(self, stock=None, tId=None):
        ...
        if tId is not None:
            ...
            raise ValueError("Must provide a stock symbol or a stock id")
        return requests.get(
            self._urls.analysis_shortinterest(tId), headers=headers, timeout=self.timeout
        ).json()
    ...
    def get_financials(self, stock=None):
        ...
        headers = self.build_req_headers()
        return requests.get(
            self._urls.fundamentals(self.get_ticker(stock)), headers=headers, timeout=self.timeout
        ).json()
    ...
    def get_news(self, stock=None, tId=None, Id=0, items=20):
        ...
        if tId is not None:
            ...
            raise ValueError("Must provide a stock symbol or a stock id")
        return requests.get(
            self._urls.news(tId, Id, items), headers=headers, timeout=self.timeout
        ).json()

    def get_bars(
        self, stock=None, tId=None, interval="m1", count=1, extendTrading=0, timeStamp=None
    ):
        """
    ...
    def get_bars_crypto(
        ...
        df.index.name = "timestamp"
        response = requests.get(
            self._urls.bars_crypto(tId), params=params, headers=headers, timeout=self.timeout
        )
        result = response.json()
        time_zone = timezone(result[0]["timeZone"])
        for row in result[0]["data"]:
    ...
    def get_options_bars(
        self, derivativeId=None, interval="1m", count=1, direction=1, timeStamp=None
    ):
        """
        get bars returns a pandas dataframe
        params:
        ...
        df.index.name = "timestamp"
        response = requests.get(
            self._urls.options_bars(derivativeId),
            params=params,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def get_calendar(self, stock=None, tId=None):
        ...
        response = requests.get(
            self._urls.bars(tId), params=params, headers=headers, timeout=self.timeout
        )
        result = response.json()
        time_zone = timezone(result[0]["timeZone"])
        last_trade_date = datetime.fromtimestamp(
            int(result[0]["data"][0].split(",")[0])
        ...
        for d in result[0]["dates"]:
            if d["type"] == "T":
                ...
                market_close = today.replace(
                    hour=int(d["end"].split(":")[0]), minute=int(d["end"].split(":")[1]), second=0
                )
    ...
    def get_dividends(self):
        ...
        data = {}
        response = requests.post(
            self._urls.dividends(self._account_id), json=data, headers=headers, timeout=self.timeout
        )
        return response.json()
    ...
    def get_five_min_ranking(self, extendTrading=0):
        ...
        params = {
            "regionId": self._region_code,
            "userRegionId": self._region_code,
            "platform": "pc",
            "limitCards": "latestActivityPc",
        }
        response = requests.get(
            self._urls.rankings(), params=params, headers=headers, timeout=self.timeout
        )
    ...
    def get_watchlists(self, as_list_symbols=False):
        ...
        params = {"version": 0}
        response = requests.get(
            self._urls.portfolio_lists(), params=params, headers=headers, timeout=self.timeout
        )
    ...
    def get_press_releases(self, stock=None, tId=None, typeIds=None, num=50):
        ...
        headers = self.build_req_headers()
        response = requests.get(
            self._urls.press_releases(tId, typeIds, num), headers=headers, timeout=self.timeout
        )
        result = response.json()
    ...
    def get_calendar_events(self, event, start_date=None, page=1, num=50):
        ...
        headers = self.build_req_headers()
        response = requests.get(
            self._urls.calendar_events(event, self._region_code, start_date, page, num),
            headers=headers,
            timeout=self.timeout,
        )
        result = response.json()
...
class paper_webull(webull):
    ...
    def get_account(self):
        ...
        headers = self.build_req_headers()
        response = requests.get(
            self._urls.paper_account(self._account_id), headers=headers, timeout=self.timeout
        )
        return response.json()
    ...
    def get_account_id(self):
        ...
        headers = self.build_req_headers()
        response = requests.get(
            self._urls.paper_account_id(), headers=headers, timeout=self.timeout
        )
        result = response.json()
    ...
    def get_history_orders(self, status="Cancelled", count=20):
        headers = self.build_req_headers(include_trade_token=True, include_time=True)
        response = requests.get(
            self._urls.paper_orders(self._account_id, count) + str(status),
            headers=headers,
            timeout=self.timeout,
        )
        return response.json()
    ...
    def place_order(
        ...
        response = requests.post(
            self._urls.paper_place_order(self._account_id, tId),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def modify_order(
        ...
        response = requests.post(
            self._urls.paper_modify_order(self._account_id, order["orderId"]),
            json=data,
            headers=headers,
            timeout=self.timeout,
        )
        if response:
            ...
            print(f"Modify didn't succeed. {response} {response.json()}")
            return False
    ...
    def cancel_order(self, order_id):
        ...
        headers = self.build_req_headers()
        response = requests.post(
            self._urls.paper_cancel_order(self._account_id, order_id),
            headers=headers,
            timeout=self.timeout,
        )
    ...
    def get_social_posts(self, topic, num=100):
        ...
        response = requests.get(
            self._urls.social_posts(topic, num), headers=headers, timeout=self.timeout
        )
        result = response.json()
        return result
    ...
    def get_social_home(self, topic, num=100):
        ...
        response = requests.get(
            self._urls.social_home(topic, num), headers=headers, timeout=self.timeout
        )
        result = response.json()
        return result
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Interface with Webull. Paper trading is not the default."
    )
